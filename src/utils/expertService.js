...
export const EXPERTS = {
  ...
  'Marvelous Arku': {
    email: 'marvelous.arku@rapid-works.io',
...
export const EXPERT_EMAIL_MAP = {
  ...
  'marvelous.arku@rapid-works.io': 'Marvelous Arku'
};
...
export const EXPERT_ROLE_EMAIL_MAP = {
  ...
  'Business Development Expert': 'marvelous.arku@rapid-works.io',
  'Business Development Experte': 'marvelous.arku@rapid-works.io',
