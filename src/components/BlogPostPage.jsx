    ...
    <div className="pt-20"> {/* Add padding top for header */}
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="max-w-3xl mx-auto mb-6">
          <Link href="/blogs" className="text-purple-600 hover:text-purple-800 font-medium flex items-center">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {relatedPosts.map(related => (
                <div key={related.slug || related.id} className="bg-white border rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                  {related.imageUrl && (
                    <Link href={`/blogs/${related.slug || related.id}`} className="block h-48 overflow-hidden">
                      <img 
                  ...
                  <div className="p-5">
                    ...
                    <h4 className="text-lg font-semibold mb-2">
                      <Link href={`/blogs/${related.slug || related.id}`} className="hover:text-purple-600 transition-colors">
                        {related.title}
                      </Link>
                    </h4>
