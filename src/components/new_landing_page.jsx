...
export default function RapidWorksPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-purple-200 selection:text-purple-900">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="text-white relative overflow-hidden flex items-center h-[70vh] min-h-[500px]">
          ...
          <div className="absolute inset-0 z-0">
            <img 
              src="/images/landingpage_hero.png" 
      ...
      {/* Webinar section temporarily hidden */}
      {/* 
        ...
        <div className="container mx-auto px-6">
          <div >
            <div className="relative overflow-hidden rounded-2xl h-[475px]">
              ...
              <img
                src="/images/landing_rapid_ansewes.png"
      ...
      */}
      ...
      <section ref={servicesRef} className="py-20 relative bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-4xl font-bold mb-4 text-black">{content.services.title}</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div className="group">
              <div className="relative overflow-hidden rounded-2xl aspect-[3/2] mb-0">
                ...
                <img
                  src="/images/landing_partners.png"
      ...
      <section className="py-20 relative">
         <div className="container mx-auto px-6">
           <div className="text-center mb-16">
             <h3 className="text-3xl md:text-4xl font-bold mb-4 text-black">{content.financingSection.title}</h3>
             <p className="text-xl text-gray-600 max-w-2xl mx-auto">
           ...
           <div >
             <div className="relative overflow-hidden rounded-2xl h-[475px]">
                ...
                <img
                  src="/images/landing_financing.png"
                ...
                <div className="absolute inset-0 z-20 p-6 md:p-12 flex flex-col md:flex-row items-center justify-between">
                  <div className="mb-8 md:mb-0 w-full md:w-3/5">
                    ...
                    <Link href="/financing" className="inline-flex items-center gap-2 text-white font-medium bg-white/20 backdrop-blur-md px-4 py-2 rounded-lg hover:bg-white/30 transition-all">
          ...
          <div className="bg-gradient-to-br from-black to-gray-800 rounded-3xl overflow-hidden relative">
            ...
            <div className="md:flex relative z-10">
              <div className="md:w-1/2 p-10 md:p-16">
                ...
                <Link href="/bundle" className="bg-white text-black px-8 py-4 rounded-full font-medium hover:shadow-lg hover:shadow-white/20 transition-all flex items-center gap-2 inline-flex">
      ...
      <section ref={ctaRef} className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-black">{content.cta.title}</h3>
