...
const BundlePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-violet-200 selection:text-violet-900 overflow-x-hidden">
      {/* Noise overlay */}
      ...
      {/* Decorative elements */}
      <div className="fixed top-0 right-0 w-1/3 h-1x/3 bg-gray-200 rounded-full filter blur-3xl opacity-20 -z-10 transform translate-x-1/3 -translate-y-1/3"></div>
